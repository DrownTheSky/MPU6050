...
void IMUupdate(FLOAT_XYZ *Gyr_rad,FLOAT_XYZ *Acc_filt,MV_measure *Att_Angle)
{
	uint8_t i;
...
//	Att_Angle->pit = -atan2(2.f * q2q3 + 2.f * q0q1, q0q0 - q1q1 - q2q2 + q3q3)* 57.3f ; // pitch
	...
	MV.yaw += Gyr_rad->Z *RadtoDeg*0.015f; 
	MV.rol = -asin(2.f * (q1q3 - q0q2))* 57.3f; 
	MV.pit = -atan2(2.f * q2q3 + 2.f * q0q1, q0q0 - q1q1 - q2q2 + q3q3)* 57.3f ; // pitch
	for(i=0;i<9;i++)
	{
